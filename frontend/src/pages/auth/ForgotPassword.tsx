...
export function ForgotPassword() {
  ...
  const handleResetPassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const error = err as Error;
      setError(error.message || "Failed to reset password. Please check your OTP and try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <Card className="border-0 shadow-none sm:border sm:shadow-sm">
      ...
      <CardContent>
        <div className="grid gap-4">
          ...
          {success && <div className="text-sm font-medium text-green-600 bg-green-50 dark:text-green-400 dark:bg-green-950/50 p-3 rounded-md">{success}</div>}
